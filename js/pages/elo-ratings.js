...
const abbreviationMap = {
    ...
    '清水エスパルス': '清水', '横浜FC': '横浜FC', 'V・ファーレン長崎': '長崎', 'ファジアーノ岡山': '岡山', 'ベガルタ仙台': '仙台', 'ジェフユナイテッド千葉': '千葉', 'いわきFC': 'いわき', '徳島ヴォルティス': '徳島', 'ヴァンフォーレ甲府': '甲府', 'モンテディオ山形': '山形', '愛媛FC': '愛媛', 'ブラウブリッツ秋田': '秋田', '大分トリニータ': '大分', 'レノファ山口FC': '山口', '鹿児島ユナイテッドFC': '鹿児島', '水戸ホーリーホック': '水戸', 'ロアッソ熊本': '熊本', '藤枝MYFC': '藤枝', '栃木SC': '栃木SC',
    'ザスパ群馬': '群馬', 'RB大宮アルディージャ': '大宮', 'FC今治': '今治',
    'カターレ富山': '富山', 'FC大阪': 'FC大阪', 'ツエーゲン金沢': '金沢', '松本山雅FC': '松本', 'ヴァンラーレ八戸': '八戸', 'ギラヴァンツ北九州': '北九州', 'テゲバジャーロ宮崎': '宮崎', '福島ユナイテッドFC': '福島', 'SC相模原': '相模原', '奈良クラブ': '奈良', 'ガイナーレ鳥取': '鳥取', 'FC琉球': '琉球', 'AC長野パルセイロ': '長野', 'カマタマーレ讃岐': '讃岐', 'アスルクラロ沼津': '沼津', 'FC岐阜': '岐阜', 'Y.S.C.C.横浜': 'YS横浜', '栃木シティ': '栃木C', '高知ユナイテッドSC': '高知'
};
