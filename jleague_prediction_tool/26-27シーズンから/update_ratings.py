...
WEB_ROOT_PATH = 'C:/Users/mura/Desktop/その他/webサイト/jleague-big-club'
...
def main():
    ...
    team_name_normalization_map = {
        ...
        '栃木': '栃木SC',  # <<<--- この行を追加
        'ザスパクサツ群ma': 'ザスパ群馬', 'Ｙ．Ｓ．Ｃ．Ｃ．横浜': 'YS横浜', 'レイラック滋賀': '滋賀', 'レイラック滋賀FC': '滋賀'
        # 他に必要な正規化があればここに追加
    }
    ...
    # --- 修正箇所：過去のデータは無視し、今年のチーム全員を1500にリセット ---
    flat_ratings = {}
    for league, teams in league_teams_this_season.items():
        for team in teams:
            flat_ratings[team] = 1500
    
    print("全クラブのレートを1500にリセットし、今年の成績のみで計算を開始します。")
    # ----------------------------------------------------------------------
