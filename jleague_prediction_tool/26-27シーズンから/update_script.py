...
# --- 設定 ---
# <<< 最重要修正点: データフォルダのパスを、ご指定の固定パスに変更
DATA_FOLDER = r'C:\Users\mura\Desktop\その他\webサイト\jleague-big-club\data'
...
TARGET_FILES = [
    ...
    "5league-rankings.csv" # 5大リーグのファイルも追加しておくと便利かもしれません
]
...
# --- メイン処理 ---
def main():
    print(f"指定されたデータフォルダ: {DATA_FOLDER}")
